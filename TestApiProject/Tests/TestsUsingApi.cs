...
namespace TestApiProject.Tests
{
    ...
    class TestsUsingApi
    {
        ...
        // [Test]
        //public void CheckThatIsPossibleToChangeInformationByApi()
        //{
        //    Context.Token = new AuthRequests().SendRequestSignUpPost(new ClientSignUpModel
        //    {
        //        Email = USER_EMAIL + DateTime.Now.ToString("ddmmyyyyhhmmss"),
        ...
        //    var token = new InformationRequests().SendRequestChangeLoginPost(
        //        new InformationModel
        //        {
        //            Industry = "lololo",
        //            LocationName = "Денвер, Колорадо, США",
        //            LocationLatitude = 39.7392358,
        //            LocationLongitude = -104.990251,
        //            LocationCityName = "Денвер",
        //            LocationAdmin1Code = "CO",
